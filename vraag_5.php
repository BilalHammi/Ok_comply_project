...
if (isset($_POST['pijl_r_x'])) {
    if (strlen($_POST["vraag"]) === 9) {
        $vraag5 = $_POST["vraag"];
        $_SESSION["question5"] = $vraag5;
        header("Location: vraag_6.php");
    } else {
        $error = "<p class='font-bold flex justify-center mt-1'>Your phone needs to have 10 nummbers!</p>";
    }
}
...
<body class=" bg-gray-300">
    <div class="flex flex-col items-center relative top-14">
        ...
        <div class="bg-white rounded-lg h-[9rem] w-[17rem] mt-10">
            <form action="vraag_5.php" method="POST" class="">
                <h1 class=" flex justify-center mt-2 text-sm">What is your phone number?</h1>
                ...
                <p class="font-bold text-lg absolute bottom-3 right-22 mt-[20px] ml-[7.5rem]">5/7</p>
            </form>
        </div>
    </div>
</body>
