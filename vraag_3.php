...
if (isset($_POST['pijl_r_x'])) {
    $vraag3 = $_POST["vraag"];
    $_SESSION["question3"] = $vraag3;
    header("Location: vraag_4.php");
}
...
<body class=" bg-gray-300">
    <div class="flex flex-col items-center relative top-14">
        ...
        <div class="bg-white rounded-lg h-[9rem] w-[17rem] mt-10">
            ...
            <form action="vraag_3.php" method="POST" class="">
                <h1 class="flex justify-center mt-2 text-sm">Whats your birthday?</h1>
                <input type="date" name="vraag" class="text-blue-400 rounded-lg flex align-center border-black border-2 font-bold max-w-[125px] mt-3 pl-2 ml-[4.5rem]" placeholder="Answer" required>
                <input type="image" src="img/pijl_rechts.png" name="pijl_r" class="mt-[21px] absolute bottom-3 ml-[14rem] flex justify-center">
                <p class="font-bold text-lg absolute bottom-3 right-22 mt-[20px] ml-[7.5rem]">3/7</p>
            </form>
        </div>
    </div>
</body>
